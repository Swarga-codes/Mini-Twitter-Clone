...
getAllTweets()
  ...
  return (
    <div className='bg-black w-[100%] h-[100vh] text-white p-6 ml-[16rem]'>
    <div className='mt-10'>
    <img
  ...
  <button className='flex items-center px-10 py-[0.5rem]  ml-96 bg-blue-400 text-white font-bold text-xl rounded-full'>
  Follow</button>
  </div>
